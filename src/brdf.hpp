...
public:
    ...
    virtual std::tuple<glm::vec3, Radiance, BRDFSamplingType> GetRay(glm::vec3 normal, glm::vec3 inc, Radiance diffuse, Radiance specular, Random& rnd) const;
};
...
public:
    ...
    virtual std::tuple<glm::vec3, Radiance, BRDFSamplingType> GetRay(glm::vec3 normal, glm::vec3 inc, Radiance diffuse, Radiance specular, Random& rnd) const override;
};
