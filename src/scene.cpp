...
Intersection Scene::FindIntersectKd(const Ray& __restrict__ r, bool debug) __restrict__ const{
    (void)debug;
...
Intersection Scene::FindIntersectKdOtherThan(const Ray& __restrict__ r, const Triangle* ignore, bool debug) __restrict__ const{
    (void)debug;
